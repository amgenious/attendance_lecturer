        ...
        <div className='flex flex-col justify-evenly text-center  p-4'>
            ...
            <div>
                <form className='flex flex-col' method='POST'>
                    ...
                    <input onChange={(e)=>{setPassword(e.target.value)}} className='w-[350px] h-[35px] border-2 text-white p-6 bg-gray-600 placeholder:text-gray mb-6' placeholder='password' type='password' required/>
